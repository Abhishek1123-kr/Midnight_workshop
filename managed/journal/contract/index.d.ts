...
export type Witnesses<PS> = {
  ...
  getPrivateEntryHash(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
}

export type ImpureCircuits<PS> = {
  initialize(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, []>;
  addEntry(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, []>;
}
...
export type Ledger = {
  ...
  readonly lastEntryHash: Uint8Array;
}
